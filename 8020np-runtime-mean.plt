...
set output '5050np-runtime-mean.pdf'
...
plot '5050.csv' \
  ...
  '' using 4:($9 /1000) title 'Dynamic Frontier'  linestyle  4 with linespoints, \
  ...
  '' using 4:($9 /1000):($4 <1e-2? sprintf("%.1f", $9 /1000) : "") with labels notitle offset character 2.2,character -0.4 textcolor linetype 8, \
  '' using 4:($9 /1000):($4==1e-2? sprintf("%.1f", $9 /1000) : "") with labels notitle offset character -2.2,character 0.2 textcolor linetype 8, \
  '' using 4:($9 /1000):($4==1e-1? sprintf("%.1f", $9 /1000) : "") with labels notitle offset character -2.4,character 0.6 textcolor linetype 8
